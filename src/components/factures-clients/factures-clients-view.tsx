            ...
            <Table>
              ...
              <TableBody>{filtered.map((f) => (<TableRow key={f.id}>
                ...
                <TableCell><div className="flex gap-1 flex-wrap">
                  ...
                  <Button size="sm" variant="outline" className="text-pink-600 hover:text-pink-800" onClick={() => { setScanDocNumero(f.numero); setScanDialogOpen(true); }} title="Scans & Accusé Réception (AR)"><Paperclip className="h-4 w-4" /></Button>
