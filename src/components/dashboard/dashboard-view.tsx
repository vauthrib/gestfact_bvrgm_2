    ...
    const html = `
      ...
      <head>
        ...
        <style>
          ...
          h1 { color: #db2777; }
          h2 { color: #be185d; font-size: 14pt; }
          table { width: 100%; border-collapse: collapse; margin-top: 20px; }
          th { background: #db2777; color: white; padding: 8px; text-align: left; }
            ...
            {releveData.length === 0 ? (
              ...
              <>
                ...
                <div className="mb-4 p-4 bg-pink-50 rounded-lg border border-pink-200">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <span className="text-sm text-pink-600 font-medium">Solde Réel (validés):</span>
                    ...
                    <div>
                      <span className="text-sm text-pink-600 font-medium">Solde En Cours (avec en attente):</span>
                      <div className="text-xl font-bold text-pink-700">
