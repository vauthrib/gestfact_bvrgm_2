  ...
  return (
    <div className="p-6 space-y-6 w-full">
      <div className="flex items-center justify-between">
        <div><h1 className="text-3xl font-bold text-pink-700">Règlements Clients</h1><p className="text-muted-foreground">Gérez les règlements reçus - V2.48</p></div>
                    ...
                    return (
                      <>
                        <TableRow key={item.baseNumber} className="bg-pink-50 font-semibold">
                          ...
                          <TableCell className="font-bold text-pink-700">{item.baseNumber}</TableCell>
