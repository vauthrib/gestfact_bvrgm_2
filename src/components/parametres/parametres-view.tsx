      ...
      <PermissionGate permission="users.manage">
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <PermissionGate permission="users.manage">
              <Button onClick={() => openUserDialog()} className="bg-pink-600 hover:bg-pink-700">
                  ...
                  <TableRow key={user.id}>
                    ...
                    <TableCell>
                      <Button 
                        ...
                        className={user.actif ? 'text-pink-600' : 'text-red-600'}
                      >
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-4 flex-wrap">
          ...
          <PermissionGate permission="parametres.edit">
            <Button type="button" variant="outline" onClick={() => setLayoutEditorOpen(true)} className="border-blue-300 text-pink-700 hover:bg-blue-50">
      ...
      <Dialog open={userDialogOpen} onOpenChange={setUserDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSaveUser} disabled={userLoading} className="bg-pink-600 hover:bg-pink-700">
