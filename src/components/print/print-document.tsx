          ...
          {isBL && doubleA5 ? (
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 p-4 border-b border-dashed border-gray-300" style={{ height: '148.5mm' }}>
                <div className="flex justify-between border-b-2 border-pink-600 pb-2 mb-2">
                  <div>
                    <h1 className="text-sm font-bold text-pink-700">{entreprise?.nomEntreprise || 'Entreprise'}</h1>
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-bold text-pink-700 text-xs">{getNumero()}</p>
