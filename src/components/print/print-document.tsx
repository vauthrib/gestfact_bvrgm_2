          ...
          {isBL && (
            <>
              ...
              <Button
                ...
                className={doubleA5 ? "bg-pink-600 hover:bg-pink-700" : ""}
              >
          ...
          {isBL && doubleA5 ? (
            <div className="flex flex-row h-full">
              ...
              <div className="p-3 border-r border-dashed border-gray-300" style={{ width: '148.5mm', height: '210mm' }}>
                <div className="flex justify-between border-b-2 border-pink-600 pb-1 mb-2">
                  <div>
                    <h1 className="text-xs font-bold text-pink-700">{entreprise?.nomEntreprise || 'Entreprise'}</h1>
                  ...
                  <div className="text-right">
                    ...
                    <p className="font-bold text-pink-700 text-[10px]">{getNumero()}</p>
            ...
            <>
              <div className="flex justify-between border-b-2 border-pink-600 pb-4 mb-6 p-6">
                <div>
              ...
              {showPrices && (
                <div className="text-right space-y-1 mx-6">
                  ...
                  {(documentData.totalTTC || documentData.montantTTC || documentData.montant) && (
                    <p className="text-sm italic text-gray-600 mt-3 pt-2 border-t">
                      Le montant total toutes taxes comprises, à payer, est de : <strong className="text-pink-700">{numberToWords(documentData.totalTTC || documentData.montantTTC || documentData.montant)}</strong>.
                    </p>
                  )}
                </div>
              )}
