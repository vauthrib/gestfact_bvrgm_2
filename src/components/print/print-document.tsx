      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        >
          ...
          {isBL && doubleA5 ? (
              ...
              <div className="relative p-3 border-r border-dashed border-gray-300" style={{ width: '148.5mm' }}>
                ...
                <div className="relative z-10 h-full flex flex-col">
                  <div className="flex justify-between border-b-2 border-pink-600 pb-1 mb-2">
                    <div>
                      <h1 className="text-[10px] font-bold text-pink-700">{entreprise?.nomEntreprise}</h1>
                    ...
                    <div className="text-right">
                      ...
                      <p className="font-bold text-pink-700 text-[8px]">{getNumero()}</p>
            ...
            <div className="p-4">
              <div className="flex justify-between border-b-2 border-pink-600 pb-4 mb-4">
                <div>
                  <h1 className="text-xl font-bold text-pink-700">{entreprise?.nomEntreprise}</h1>
